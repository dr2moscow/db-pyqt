...
if __name__ == '__main__':
    ...
    test_list.appendRow(
        [QStandardItem('test1'), QStandardItem('192.168.0.5'), QStandardItem('23221'), QStandardItem('10:00:34')])
    test_list.appendRow(
        [QStandardItem('test2'), QStandardItem('192.168.0.8'), QStandardItem('33445'), QStandardItem('11:22:11')])
